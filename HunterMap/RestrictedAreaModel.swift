...
class RestrictedAreaModel {
    ...
    private func reload() {
        ...
        restrictedAreas.sortInPlace({ $0.0.boundingRectDimension > $0.1.boundingRectDimension })
    }
    ...
    private func loadFromSource(resourceName: String) -> [RestrictedArea] {
        ...
        func handler(args: ShapeFileHandlerArgs) -> Void {
            let area = RestrictedArea(coordinates: args.coordinates,
                                      boundingRectDimension:  args.boundingRectDimension,
                                      maxLat: args.shpObject.dfYMax,
                                      minLat: args.shpObject.dfYMin,
                                      maxLng: args.shpObject.dfXMax,
                                      minLng: args.shpObject.dfXMin,
